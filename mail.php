...
if(isset($_POST['email'])) {
    ...
    $email_to = "anitacrihernandez@gmail.com, ccomercial@rentadvisor.com.co, comercial.avante.cc@rentadvisor.com.co, comercial@rentadvisor.com.co, contact@brandspa.com";
  ...
  if(!preg_match($email_exp,$email_from)) {
    $error_message .= 'La dirección de correo ingresada no es válida.<br />';
  }
